...
VOICE_PERSONAS = {
    ...
    " Professional Narrator": {"voice_name": "en-US-Wavenet-D", "pitch": 0.0, "speaking_rate": 1.0},
...
def apply_custom_css():
    ...
    <style>
        ...
        div.stButton > button:hover {
            ...
            color: #f54a33 !important;
        }

        div.stDownloadButton > button {
            background-color: rgba(92,255, 10, 0.1) !important;
        ...
        div.stDownloadButton > button:hover {
            ...
            background-color: #b0f5c5 !important;
        }
    ...
    .processing-spinner {
        border: 3px solid rgba(255, 92, 10, 0.2);
...
def processing_button(text):
    button_html = f"""
    <button class="processing-button" id="processingButton">
    ...
    <script>
    const button = document.getElementById('processingButton');
...
if st.button(" Generate Audio"):
    if text_input.strip():
        ...
        st.markdown('</div>', unsafe_allow_html=True)
        # Create a placeholder for the processing button
        processing_placeholder = st.empty()
        
        # Show processing button
        processing_placeholder.markdown(processing_button("Processing Audio"), unsafe_allow_html=True)
